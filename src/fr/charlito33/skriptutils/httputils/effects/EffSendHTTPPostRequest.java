...
public class EffSendHTTPPostRequest extends Effect {
    ...
    protected void execute(Event e) {
        try {
            HttpURLConnection connection = (HttpURLConnection) new URL("http://charlito33.fr.nf/api/get-content-from-url.php?type=POST&url=" + url.getSingle(e) + "&payload=" + payload.getSingle(e)).openConnection();
    ...
    public boolean init(Expression<?>[] expr, int i, Kleenean kleenean, SkriptParser.ParseResult parseResult) {
        ...
        payload = (Expression<String>) expr[1];
